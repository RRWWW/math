...
```{r vector-construction, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='vector space construction', engine.opts=list(extra.preamble=c("\\usepackage{pgfplots}"))}
\tikzset{
  box/.style={
    draw=black,
    rectangle,
