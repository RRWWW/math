...
[Feynman method of differentiation / derivative]^[\@ref(feynman-method-of-differentiation-derivative)]^
...
\overset{\text{Dirac bracket}}{\rightarrow} & \sum\limits _{i}\left\langle \hat{f}_{{\scriptscriptstyle i}}\middle|f\right\rangle \left\langle \hat{f}_{{\scriptscriptstyle i}}\right|=\left\langle f\right|\\
\Updownarrow\\
