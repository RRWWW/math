...
```{r, echo=FALSE, cache=TRUE, fig.cap="Euclid space construction ^[https://zhuanlan.zhihu.com/p/85867887]", out.width = '75%'}
knitr::include_graphics("img/Euclid-space-construction.png")
```
...
```{r, echo=FALSE, cache=TRUE, fig.cap="Poisson equation rigorous proof by general function and Green theorem", out.width = '75%'}
knitr::include_graphics("img/Poisson-equation-rigorous-proof.png")
```
...
```{r, echo=FALSE, cache=TRUE, fig.cap="metric vs. inner product", out.width = '75%'}
knitr::include_graphics("img/metric-vs-inner.png")
```

```{r, echo=FALSE, cache=TRUE, fig.cap="Euclid space construction", out.width = '75%'}
knitr::include_graphics("img/Euclid-space-construction.png")
```
