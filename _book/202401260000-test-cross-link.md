...
\begin{figure}
\includegraphics[width=0.25\linewidth]{202401260000-test-cross-link_files/figure-latex/parabola-arc-with-points-1} \caption{parabola arc with points}(\#fig:parabola-arc-with-points)
\end{figure}
