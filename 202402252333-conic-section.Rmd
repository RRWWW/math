...
```{r, echo=FALSE, engine='tikz', cache=TRUE,  out.width='75%', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', fig.cap='parabola defined by focus, directrix, eccentricity'}
\begin{tikzpicture}
  \draw[help lines, color=gray!30, dashed] (-4.9,-4.9) grid (4.9,4.9);
  \draw[->,thick] (-5,0)--(5,0) node[right] {$x$};
  \draw[->,thick] (0,-5)--(0,5) node[above] {$y$};
  
  \fill (0,1) circle (.05) node[right] {$F$};
  \node[left] at (-4.5,-1) {$L$};
  \draw[-] (-4.5,-1)--(4.5,-1);

  \draw[blue,line width=1pt,domain=-4:4, samples=100] plot(\x,{0.25*(\x)^2});
\end{tikzpicture}
```
...
```{r, echo=FALSE, cache=TRUE, fig.cap="conic sections: ellipse", out.width = '75%'}
show_fig("img/conic-sections-ellipse.svg")
```

```{r, echo=FALSE, cache=TRUE, fig.cap="conic sections: parabola", out.width = '75%'}
show_fig("img/conic-sections-parabola.svg")
```

```{r, echo=FALSE, cache=TRUE, fig.cap="conic sections: hyperbola", out.width = '75%'}
show_fig("img/conic-sections-hyperbola.svg")
```
...
$$
```{r, echo=FALSE, cache=TRUE, fig.cap="polar conic sections: ellipse", out.width = '75%'}
show_fig("img/conic-sections-polar-ellipse.svg")
```

```{r, echo=FALSE, cache=TRUE, fig.cap="polar conic sections: parabola", out.width = '75%'}
show_fig("img/conic-sections-polar-parabola.svg")
```

```{r, echo=FALSE, cache=TRUE, fig.cap="polar conic sections: hyperbola", out.width = '75%'}
show_fig("img/conic-sections-polar-hyperbola.svg")
```
