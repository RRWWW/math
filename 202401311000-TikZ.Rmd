...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap=''}
\begin{tikzpicture}
  \draw (-1,1)--(0,0)--(1,2);
\end{tikzpicture}
```
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png',  out.width=if (knitr:::is_html_output()) '100%', fig.cap='Brachistochrone Curve'}
\begin{tikzpicture}
  \def\a{1.5} % amplitude
  \def\b{2}   % frequency
  \draw[->] (-0.2,0)--(4.2,0) node[right, font=\small] {$x$};
...
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png',  out.width='90%', fig.cap='Brachistochrone Curve'}
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', fig.width=10, fig.height=2, out.width=if (knitr:::is_html_output()) '100%'}
\begin{tikzpicture}
  \draw (-1,1)--(0,0)--(1,2);
\end{tikzpicture}
```
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', fig.width=10, fig.height=2, out.width=if (knitr:::is_html_output()) '20%'}
\begin{tikzpicture}
  \draw (-1,1)--(0,0)--(1,2);
\end{tikzpicture}
```
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '50%', fig.cap='rounded corner pseudo-closed triangle'}
\begin{tikzpicture}
  \draw[rounded corners] (-1,1)--(0,0)--(1,2)--(-1,1);
\end{tikzpicture}
```
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '50%', fig.cap='rounded corner triangle'}
\begin{tikzpicture}
  \draw[rounded corners] (-1,1)--(0,0)--(1,2)--cycle;
\end{tikzpicture}
```
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '50%', fig.cap='triangle vs. pseudo-closed triangle'}
\begin{tikzpicture}
  \draw[rounded corners] (-1,1)--(0,0)--(1,2)--cycle;
  \draw[rounded corners] (-1,1)--(0,0)--(1,2)--(-1,1);
\end{tikzpicture}
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '50%', fig.cap='rectangle'}
\begin{tikzpicture}
  \draw (0,0) rectangle (4,2);
\end{tikzpicture}
```
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '50%', fig.cap='square'}
\begin{tikzpicture}
  \draw (0,0) rectangle (2,2);
\end{tikzpicture}
```
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '50%', fig.cap='circle'}
\begin{tikzpicture}
  \draw (0,0) circle (1);
\end{tikzpicture}
```
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '50%', fig.cap='circle and square'}
\begin{tikzpicture}
  \draw (0,0) circle (1);
  \draw (0,0) rectangle (2,2);
\end{tikzpicture}
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '50%', fig.cap='ellipse'}
\begin{tikzpicture}
  \draw (1,1) ellipse (2 and 1);
\end{tikzpicture}
```
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '50%', fig.cap='circle and ellipse arcs'}
\begin{tikzpicture}
  \draw (1 ,1) arc (0:270:1);
  \draw (6 ,1) arc (0:270:2 and 1);
\end{tikzpicture}
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '50%', fig.cap='parabola arc'}
\begin{tikzpicture}
  \draw (-1,1) parabola bend (0,0) (2,4);
\end{tikzpicture}
```
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '50%', fig.cap='parabola arc with points'}
\begin{tikzpicture}
  \draw (1,1) ellipse (2 and 1);
\end{tikzpicture}
```
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='grid and help lines'}
\begin{tikzpicture}
  \draw[step=20pt] (0,0) grid (3,2);
  \draw[help lines ,step=20pt] (4,0) grid (7,2);
\end{tikzpicture}
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '50%', fig.cap='arrows'}
\begin{tikzpicture}[scale=0.25]
  \draw[->] (0,0)--(9,0);
  \draw[<-] (0,1)--(9,1);
  \draw[<->] (0,2)--(9,2);
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '50%', fig.cap='lines'}
\begin{tikzpicture}
  \draw[line width =2pt] (0,6)--(9,6); 
  \draw[dotted]          (0,5)--(9,5); 
  \draw[densely dotted]  (0,4)--(9,4); 
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '50%', fig.cap='head styling'}
\begin{tikzpicture}[dline/.style={color= blue, line width=2pt}]
  \draw[dline] (0,0)--(9,0); 
\end{tikzpicture}
```
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '50%', fig.cap='transform: shift'}
\begin{tikzpicture}
  \draw (0,0) rectangle (2,2);
  \draw[shift={( 3, 0)}] (0,0) rectangle (2,2);
  \draw[shift={( 0, 3)}] (0,0) rectangle (2,2);
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '50%', fig.cap='transform: shift x, y'}
\begin{tikzpicture}
  \draw (0,0) rectangle (2,2);
  \draw[xshift= 100pt] (0,0) rectangle (2,2);
  \draw[xshift=-100pt] (0,0) rectangle (2,2);
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='transform: scale x, y'}
\begin{tikzpicture}
  \draw (0,0) rectangle (2,2);
  \draw[xshift= 100pt, xscale=1.5] (0,0) rectangle (2,2);
  \draw[yshift= 100pt, xscale=0.5] (0,0) rectangle (2,2);
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='transform: scale'}
\begin{tikzpicture}
  \draw (0,0) rectangle (2,2);
  \draw[xshift= 100pt, xscale=1.5] (0,0) rectangle (2,2);
  \draw[yshift= 100pt, yscale=1.5] (0,0) rectangle (2,2);
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='transform: rotate'}
\begin{tikzpicture}
  \draw (0,0) rectangle (2,2);
  \draw[xshift=125pt,rotate=45] (0,0) rectangle (2,2);
  \draw[xshift=175pt,rotate around={45:(2 ,2)}] (0,0) rectangle (2,2);
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='transform: slant'}
\begin{tikzpicture}
  \draw (0,0) rectangle (2,2);
  \draw[xshift=70pt,xslant=1] (0,0) rectangle (2,2);
  \draw[yshift=70pt,yslant=1] (0,0) rectangle (2,2);
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='flowchart'}
\tikzset{
  box/.style={
    draw=blue,
    rectangle,
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '50%', fig.cap='tree'}
\tikzset{
  box/.style={
    draw=blue,
    fill=blue!20,
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='function plot'}
\begin{tikzpicture}
  \draw[->] (-0.2,0)--(6,0) node[right] {$x$};
  \draw[->] (0,-0.2)--(0,6) node[above] {$f(x)$};
  \draw[domain=0:4] plot (\x ,{0.1* exp(\x)}) node[right] {$f(x)=\frac{1}{10}e^x$};
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '50%', fig.cap='cube'}
\begin{tikzpicture}
  \coordinate (A) at ( 1, 1, 1);
  \coordinate (B) at ( 1, 1,-1);
  \coordinate (C) at ( 1,-1,-1);
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '50%', fig.cap='cube rotate', engine.opts=list(extra.preamble=c("\\usepackage{tikz-3dplot}"))}
\usetikzlibrary{patterns}
\usetikzlibrary{3d,calc}
\tdplotsetmaincoords{45}{45}
\begin{tikzpicture}[tdplot_main_coords]
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '50%', fig.cap='cube rotate around'}
\usetikzlibrary{patterns}
\usetikzlibrary{3d,calc}
%\tdplotsetmaincoords{70}{110}
\begin{tikzpicture}[rotate around y=-15, rotate around z=7]
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '50%', fig.cap='cube perspective slant'}
\usetikzlibrary{patterns}
\usetikzlibrary{3d,calc}
\begin{tikzpicture}[y={(.5cm,.7cm)}]
  \coordinate (A) at ( 1, 1, 1);
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', out.width=if (knitr:::is_html_output()) '100%', fig.cap='modern statistics plot skills', engine.opts=list(extra.preamble=c("\\usepackage{ctex}", "\\usepackage{smartdiagram}"))}
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='plots of functions'}
\begin{tikzpicture}[domain=0:4]
  \draw[very thin,color=gray] (-0.1,-1.1) grid (3.9,3.9);
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '25%', fig.cap='2D parametric function'}
\tikz 
\draw[scale=0.5,
      domain=-3.141:3.141,
      smooth,variable=\t
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '50%', fig.cap='3D parametric function'}
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='TikZ-CD or tikz-cd matrix nodes'}
\usetikzlibrary{cd,arrows.meta}
\begin{tikzcd}
11
&
...
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='TikZ-CD or tikz-cd matrix nodes expanded longitudinally'}
\usetikzlibrary{cd,arrows.meta}
...
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='learn TikZ-CD or tikz-cd in one picture 2'}
\usetikzlibrary{cd,arrows.meta}
\begin{tikzcd}[column sep=2.75cm, %small,large,huge
			         cells={nodes={draw}}
			        ]
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='individual node without drawing margin'}
\usetikzlibrary{cd,arrows.meta,shapes}
\begin{tikzcd}[cells={nodes={draw=black,ellipse}}]
0 \ar[r] & 1 \ar[r] & |[draw=none]|\dots \ar[r] & n-1 \ar[r] & n
\end{tikzcd}
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='enclosed nodes'}
\usetikzlibrary{cd,fit,shapes.geometric}
\tikzset{E/.style = {ellipse, draw=blue, dashed,
					inner xsep=-2mm,inner ysep=-4mm,
					rotate=-30,fit=#1
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='PGFplots: normal distribution', engine.opts=list(extra.preamble=c("\\usepackage{pgfplots}"))}
\pgfplotsset{width=7cm,compat=1.18}
\begin{tikzpicture}
\begin{axis}[
]
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '90%', fig.cap='begin{axis}', engine.opts=list(extra.preamble=c("\\usepackage{pgfplots}"))}
\begin{tikzpicture}
	\begin{axis}[
		no markers,
		axis x line = center,
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='PGFplots: $x$', engine.opts=list(extra.preamble=c("\\usepackage{pgfplots}"))}
\begin{tikzpicture}
    \tikzset{
        every pin/.style={fill=yellow!50!white,rectangle,rounded corners=3pt,font=\tiny},
        small dot/.style={fill=black,circle,scale=0.3},
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='PGFplots: $x^2$', engine.opts=list(extra.preamble=c("\\usepackage{pgfplots}"))}
\begin{tikzpicture}
    \tikzset{
        every pin/.style={fill=yellow!50!white,rectangle,rounded corners=3pt,font=\tiny},
        small dot/.style={fill=black,circle,scale=0.3},
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '65%', fig.cap='declare function', engine.opts=list(extra.preamble=c("\\usepackage{pgfplots}"))}
\begin{tikzpicture}
\begin{axis}[
    declare function={
        C=4;
...
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '90%', fig.cap='PGFmathDeclareFunction: normal distributions hypothesis testing', engine.opts=list(extra.preamble=c("\\usepackage{pgfplots}"))}
% pgfmathdeclarefunction{name}{num_var}{%
%% #1 = \mu, #2 = \sigma
\pgfmathdeclarefunction{gauss}{2}{%
	\pgfmathparse{1/(#2*sqrt(2*pi))*exp(-((x-#1)^2)/(2*#2^2))}%
...
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '90%', fig.cap='PGFmathDeclareFunction: normal distributions', engine.opts=list(extra.preamble=c("\\usepackage{pgfplots}"))}
% pgfmathdeclarefunction{name}{num_var}{%
%% #1 = \mu, #2 = \sigma
\pgfmathdeclarefunction{gauss}{2}{%
  \pgfmathparse{1/(#2*sqrt(2*pi))*exp(-((x-#1)^2)/(2*#2^2))}%
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='tick texts and interpolation dashed lines', engine.opts=list(extra.preamble=c("\\usepackage{pgfplots}"))}
\begin{tikzpicture}
\begin{axis}[
    axis lines=left,
    xmin = 0, xmax = 40,
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '75%', fig.cap='PGFplots: 2D axis/axes', engine.opts=list(extra.preamble=c("\\usepackage{pgfplots}"))}
\begin{tikzpicture}
    \begin{axis}
        % empty
    \end{axis}
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '75%', fig.cap='PGFplots: axis/axes range', engine.opts=list(extra.preamble=c("\\usepackage{pgfplots}"))}
\begin{tikzpicture}
    \begin{axis}[
        xmin = -1, xmax = 11,
        ymin = -3, ymax = 1,
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='PGFplots: 1D points with pins', engine.opts=list(extra.preamble=c("\\usepackage{pgfplots}"))}
\begin{tikzpicture}
    \begin{axis}[ 
        xlabel=$x$,
        axis y line=none,
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='PGFplots: 2D points', engine.opts=list(extra.preamble=c("\\usepackage{pgfplots}"))}
\begin{tikzpicture}
    \begin{axis}[
        xlabel=$x$, ylabel=$y$,
        axis lines=center,
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='PGFplots: data points', engine.opts=list(extra.preamble=c("\\usepackage{pgfplots}"))}
\begin{tikzpicture}
    \begin{axis}[axis equal image]
        \addplot+ [only marks]
            table [x=xdata,y=ydata] {data/func.dat};
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='PGFplots: function sampling 5 points', engine.opts=list(extra.preamble=c("\\usepackage{pgfplots}"))}
\begin{tikzpicture}
    \begin{axis}[title=5 sampling points,
        xlabel=$x$,ylabel=$y$,
        axis equal image]
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='PGFplots: function sampling 55 points', engine.opts=list(extra.preamble=c("\\usepackage{pgfplots}"))}
\begin{tikzpicture}
    \begin{axis}[title=55 sampling points,
        xlabel=$x$,ylabel=$y$,
        axis equal image]
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='PGFplots: parametric function sampling', engine.opts=list(extra.preamble=c("\\usepackage{pgfplots}"))}
\begin{tikzpicture}
    \begin{axis}[
        trig format plots=rad,  % angle in radian
        axis equal image]
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='PGFplots: 3D points', engine.opts=list(extra.preamble=c("\\usepackage{pgfplots}"))}
\begin{tikzpicture}
    \begin{axis}[
        xlabel=$x$,ylabel=$y$,zlabel=$z$,
        axis lines=center,
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='PGFplots: 3D function sampling points', engine.opts=list(extra.preamble=c("\\usepackage{pgfplots}"))}
\begin{tikzpicture}
    \begin{axis}[
        xlabel=$x$,ylabel=$y$,zlabel=$z$,
        grid=major
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='lines connecting adjacent points', engine.opts=list(extra.preamble=c("\\usepackage{pgfplots}"))}
\begin{tikzpicture}
    \begin{axis}[ytick=data]
        \addplot coordinates {
            (1,0.15) (2,0.21) (3,0.33) (4,0.4)
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='smooth lines connecting adjacent points', engine.opts=list(extra.preamble=c("\\usepackage{pgfplots}"))}
\begin{tikzpicture}
    \begin{axis}[ytick=data]
        \addplot+ [smooth] coordinates {
            (1,0.15) (2,0.21) (3,0.33) (4,0.4)};
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='$\\sin(x)$ and $\\cos(x)$', engine.opts=list(extra.preamble=c("\\usepackage{pgfplots}"))}
\begin{tikzpicture}
    \begin{axis}[
        trig format plots=rad,
        xtick distance=pi/2, ytick distance=1,
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='$\\dfrac{x^2}{4}+y^2{=}1$', engine.opts=list(extra.preamble=c("\\usepackage{pgfplots}"))}
\begin{tikzpicture}
    \begin{axis}[
        trig format plots=rad,
        ymax=2.3,
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='$({\\cos(t)},{\\sin(t)},{t})$', engine.opts=list(extra.preamble=c("\\usepackage{pgfplots}"))}
\begin{tikzpicture}
    \begin{axis}[trig format plots=rad]
        \addplot3+ [variable=t,
                    domain=0:3*pi,
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='$f(x,y)=xy$', engine.opts=list(extra.preamble=c("\\usepackage{pgfplots}"))}
\begin{tikzpicture}
    \begin{axis}
        \addplot3+ [no markers, mesh] {x*y};
    \end{axis}
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='$x^2+y^2+z^2=1$', engine.opts=list(extra.preamble=c("\\usepackage{pgfplots}"))}
\begin{tikzpicture}
    \begin{axis}[
        view={120}{30},
        trig format plots=rad,
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='polar coordinate $\\rho=\\cos 2\\theta$', engine.opts=list(extra.preamble=c("\\usepackage{pgfplots}"))}
\begin{tikzpicture}
    \begin{axis}[
      title={$\rho=\cos 2\theta$},
      axis equal image
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='polar coordinate axes', engine.opts=list(extra.preamble=c("\\usepackage{pgfplots}"))}
\usepgfplotslibrary{polar}
\begin{tikzpicture}
    \begin{polaraxis}
        \addplot+ coordinates
...
::: {.col data-latex="{0.45\textwidth}"}
```{r, echo=FALSE, cache=TRUE, engine='tikz', fig.ext=if (knitr:::is_latex_output()) 'pdf' else 'png', out.width=if (knitr:::is_html_output()) '100%', fig.cap='declare function', engine.opts=list(extra.preamble=c("\\usepackage{pgfplots}"))}
\begin{tikzpicture}
\begin{axis}[
	xmin=-3,   xmax=3,
	ymin=-3,   ymax=3,
